...
namespace mull { namespace objc {
        ...
        void mull::objc::Runtime::addClassesFromSection(void *sectionPtr,
            ...
            NSLog(@"mull::objc::Runtime> adding section for later registration: %p, size: %lu", sectionPtr, sectionSize);
            ...
            for (uintptr_t i = 0; i <= count / 2; i += 1) {
                ...
                NSLog(@"mull::objc::Runtime> adding class for registration: %s",clzPointer->getDataPointer()->getName());
        ...
        void mull::objc::Runtime::addCategoriesFromSection(void *sectionPtr,
            ...
            NSLog(@"Runtime> addCategoriesFromSection");
