...
void agent_main(const void *data, bool *stay_resident) {
    NSLog(@"init from agent_main");
    *stay_resident = TRUE;

    const char * cls = "BTSandbox";
    NSLog(@"before: %@", objc_getClass(cls));
    getLocalImages();
    NSLog(@"after: %@", objc_getClass(cls));
    if(objc_getClass("BTSandbox") != nullptr) {
